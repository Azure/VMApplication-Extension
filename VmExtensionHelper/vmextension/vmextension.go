...
type getVMExtensionEnvironmentManager interface {
	...
	getCurrentSequenceNumber(ctx log.Logger, retriever seqno.ISequenceNumberRetriever, name string, version string) (uint, error)
...
func (*prodGetVMExtensionEnvironmentManager) getCurrentSequenceNumber(ctx log.Logger, retriever seqno.ISequenceNumberRetriever, name string, version string) (uint, error) {
